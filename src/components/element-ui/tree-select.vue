...
<template>
  <div>
    <div class="mask" v-show="isShowSelect" @click="handleMaskClick"></div>
    <el-popover 
      ...
      @hide="popoverHide"
    >
      <el-tree class="common-tree" :style="style" ref="tree" 
        :data="data" 
        :props="defaultProps"
      ...
      <el-select :style="selectStyle" slot="reference" ref="select" :size="size"
        ...
        @visible-change="handleShowOrHidden"
        class="tree-select"
      >
...
export default {
  ...
  methods: {
    handleMaskClick() {
      console.log('点击了mask', this.isShowSelect);
      this.isShowSelect = !this.isShowSelect
    },
    handleShowOrHidden(value) {
      console.log('select显示或隐藏 show or hidden', value)
    },
    ...
    initCheckedData () {
      if (this.multiple) {
        ...
        if (this.checkedKeys.length > 0) {
          console.log('initCheckedData this.checkedKeys', this.checkedKeys);
